// WebServer.cpp : main source file for WebServer.exe
//
...
//		run nmake -f WebServerps.mk in the project directory.
#include "initguid.h"
#include "WebServer.h"
#include "WebServer_i.c"
...
//	HRESULT hRes = ::CoInitializeEx(NULL, COINIT_MULTITHREADED);
	...
	while(lpszToken != NULL)
	{
		...
		{
			_Module.UpdateRegistryFromResource(IDR_WEBSERVER, FALSE);
		...
		{
			_Module.UpdateRegistryFromResource(IDR_WEBSERVER, TRUE);
